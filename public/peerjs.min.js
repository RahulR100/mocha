		...
		EgBh: [
			function (require, module, exports) {
				...
				'undefined' != typeof window &&
					(r = module.exports.BlobBuilder = window.WebKitBlobBuilder || window.MozBlobBuilder || window.MSBlobBuilder || window.BlobBuilder),
				...
				(module.exports = i),
					...
					(r.prototype.unpack_raw = function (t) {
						if (this.length < this.index + t)
							throw new Error('BinaryPackFailure: index is out of range ' + this.index + ' ' + t + ' ' + this.length);
								...
								if (e && 'object' === o(e.video)) {
									...
									if (
										...
										if (
											...
											return t.mediaDevices.enumerateDevices().then(function (r) {
												...
												return (
													!t && r.length && u.includes('back') && (t = r[r.length - 1]),
													t && (e.video.deviceId = d.exact ? { exact: t.deviceId } : { ideal: t.deviceId }),
													(e.video = i(e.video)),
					...
					if (
						...
						var t = function (e, t) {
							return {
								...
								get dtmf() {
									return (
										void 0 === this._dtmf && ('audio' === t.kind ? (this._dtmf = e.createDTMFSender(t)) : (this._dtmf = null)), this._dtmf
									);
								},
								_pc: e
							};
						...
						(e.RTCPeerConnection.prototype.getSenders = function () {
							...
							Object.defineProperty(e.RTCRtpSender.prototype, 'dtmf', {
								get: function () {
									return (
										void 0 === this._dtmf &&
											('audio' === this.track.kind ? (this._dtmf = this._pc.createDTMFSender(this.track)) : (this._dtmf = null)),
										this._dtmf
									);
								}
							});
			...
			function (require, module, exports) {
				...
				(r.localCName = r.generateIdentifier()),
					...
					(r.writeExtmap = function (r) {
						return (
							'a=extmap:' + (r.id || r.preferredId) + (r.direction && 'sendrecv' !== r.direction ? '/' + r.direction : '') + ' ' + r.uri + '\r\n'
						);
					}),
					...
					(r.parseRtpParameters = function (e) {
						for (
							var t = { codecs: [], headerExtensions: [], fecMechanisms: [], rtcp: [] }, a = r.splitLines(e)[0].split(' '), n = 3;
							n < a.length;
							n++
						) {
							var s = a[n],
						...
						o.length > 0 && o[0].length > 1 && o[0][0] === c && (t = o[0][1]),
							n.codecs.forEach(function (r) {
								if ('RTX' === r.name.toUpperCase() && r.parameters.apt) {
									...
									c && t && (e.rtx = { ssrc: t }),
										a.push(e),
										s && (((e = JSON.parse(JSON.stringify(e))).fec = { ssrc: c, mechanism: i ? 'red+ulpfec' : 'red' }), a.push(e));
								}
							}),
					...
					var f = function (t) {
						...
						if (((t.iceServers = n(t.iceServers || [], d)), (this._iceGatherers = []), t.iceCandidatePoolSize))
							for (var i = t.iceCandidatePoolSize; i > 0; i--)
								this._iceGatherers.push(new c.RTCIceGatherer({ iceServers: t.iceServers, gatherPolicy: t.iceTransportPolicy }));
					...
					Object.defineProperty(f.prototype, 'localDescription', {
						...
						(f.prototype._createTransceiver = function (e, t) {
							...
							if (this.usingBundle && r)
								(n.iceTransport = this.transceivers[0].iceTransport), (n.dtlsTransport = this.transceivers[0].dtlsTransport);
							else {
							...
							return (
								...
								(this.transceivers[e].bufferCandidates = function (t) {
									...
									(n.state = a ? 'completed' : 'gathering'),
										null !== r.transceivers[e].bufferedCandidateEvents && r.transceivers[e].bufferedCandidateEvents.push(t);
								}),
							...
							if (i) {
								...
								void 0 !== i.offerToReceiveAudio &&
									...
									void 0 !== i.offerToReceiveVideo &&
										(a = !0 === i.offerToReceiveVideo ? 1 : !1 === i.offerToReceiveVideo ? 0 : i.offerToReceiveVideo);
							}
							for (
								...
								: new Promise(function (a, i) {
										...
										if (t && '' !== t.candidate) {
											...
											for (
												...
												(n.transceivers[u].rejected ||
													(n.transceivers[u].iceTransport.addRemoteCandidate({}),
													((r = e.getMediaSections(n._remoteDescription.sdp))[u] += 'a=end-of-candidates\r\n'),
													(n._remoteDescription.sdp = e.getDescription(n._remoteDescription.sdp) + r.join('')),
													!n.usingBundle));
												u++
											);
				...
				function p(n, i) {
					...
					(n.RTCPeerConnection = function (r) {
						return (
							r &&
								r.iceServers &&
								((r.iceServers = (0, t.filterIceServers)(r.iceServers, i.version)), e.log('ICE servers after filtering:', r.iceServers)),
							new c(r)
						);
					}),
					...
					if (n.RTCIceCandidate && !(n.RTCIceCandidate && 'foundation' in n.RTCIceCandidate.prototype)) {
						...
						(n.RTCIceCandidate = function (t) {
							...
							t.wrapPeerConnectionEvent(n, 'icecandidate', function (e) {
								return (
									e.candidate && Object.defineProperty(e, 'candidate', { value: new n.RTCIceCandidate(e.candidate), writable: 'false' }), e
								);
							});
					}
				}
			...
			function (require, module, exports) {
				...
				function o() {
					var { window: n } = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
						m = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : { shimChrome: !0, shimFirefox: !0, shimEdge: !0, shimSafari: !0 },
						o = e.log,
						h = e.detectBrowser(n),
						d = {
							browserDetails: h,
		...
		BHXf: [
			function (require, module, exports) {
				...
				var o = r(require('peerjs-js-binarypack')),
					n = require('./supports'),
					i = {
						iceServers: [{ urls: 'stun:stun.l.google.com:19302' }, { urls: 'turn:0.peerjs.com:3478', username: 'peerjs', credential: 'peerjsp' }],
			...
			function (require, module, exports) {
				...
				function o(e, n, o, s, i) {
					...
					var c = new r(o, s || e, i),
						f = t ? t + n : n;
					return (
						e._events[f] ? (e._events[f].fn ? (e._events[f] = [e._events[f], c]) : e._events[f].push(c)) : ((e._events[f] = c), e._eventsCount++), e
					);
				}
				function s(e, t) {
						...
						(n.prototype._print = function (n) {
							...
							n >= o.All
								...
								: n >= o.Warnings
									...
									: n >= o.Errors && console.error.apply(console, e(['ERROR'], r(s)));
						}),
						n
					);
				})();
							...
							(r.prototype.start = function (e, t) {
								...
								!this._socket &&
									...
									(this._socket.onclose = function (e) {
										n._disconnected ||
											(i.default.log('Socket closed.', e), n._cleanup(), (n._disconnected = !0), n.emit(c.SocketEventType.Disconnected));
									}),
						...
						return (
							(o.prototype.startConnection = function (e) {
								...
								if (
									...
									this.connection.type === c.ConnectionType.Media && e._stream && this._addTracksToConnection(e._stream, n),
									e.originator)
								) {
								...
								return n(this, void 0, Promise, function () {
									...
									return t(this, function (t) {
										switch (t.label) {
											...
											case 4:
												return (
													...
													this.connection.type === c.ConnectionType.Data &&
														((d = this.connection),
														(s = e(e({}, s), { label: d.label, reliable: d.reliable, serialization: d.serialization }))),
											...
											case 7:
												return (
													(u = t.sent()), o.emitError(c.PeerErrorType.WebRTC, u), r.default.log('Failed to createOffer, ', u), [3, 8]
												);
											case 8:
												return [2];
										}
									...
									return t(this, function (t) {
										switch (t.label) {
											...
											case 1:
												return (
													t.trys.push([1, 3, , 4]),
													[4, a.addIceCandidate(new RTCIceCandidate({ sdpMid: i, sdpMLineIndex: o, candidate: n }))]
												);
											case 2:
							...
							(s.prototype.close = function () {
								(this._buffer = []),
									...
									this.dataChannel &&
										...
										(this._dc = null)),
									this._encodingQueue &&
										(this._encodingQueue.destroy(), this._encodingQueue.removeAllListeners(), (this._encodingQueue = null)),
										...
										for (; i; )
											try {
												if (
													((r = 1),
													o &&
														(n = 2 & s[0] ? o.return : s[0] ? o.throw || ((n = o.return) && n.call(o), 0) : o.next) &&
														!(n = n.call(o, s[1])).done)
												)
													return n;
							...
							return (
								...
								s.util.supports.audioVideo || s.util.supports.data
									? r && !s.util.validateId(r)
										? (c._delayedAbort(d.PeerErrorType.InvalidID, 'ID "' + r + '" is invalid'), c)
										: (r
												? c._initialize(r)
												: c._api
														.retrieveId()
											...
											c)
									: (c._delayedAbort(d.PeerErrorType.BrowserIncompatible, 'The current browser does not support WebRTC'), c)
							);
						}
						return (
							e(i, o),
							...
							(i.prototype._handleMessage = function (e) {
								...
								switch (o) {
									...
									case d.ServerMessageType.Offer:
										...
										if (
											((_ = this.getConnection(s, c)) && (_.close(), a.default.warn('Offer received for existing Connection ID:' + c)),
											i.type === d.ConnectionType.Media)
										)
											(_ = new l.MediaConnection(s, this, { connectionId: c, _payload: i, metadata: i.metadata })),
							...
							(i.prototype.connect = function (e, t) {
								if ((void 0 === t && (t = {}), this.disconnected))
									return (
										...
										void this.emitError(d.PeerErrorType.Disconnected, 'Cannot connect to new Peer after disconnecting from server.')
									);
